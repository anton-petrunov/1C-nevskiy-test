...
3. Далее вам необходимо выбрать вариант работы с файлом обработки: либо как **пользователь**, либо как **программист-разработчик**
### Запуск проекта в режиме пользователя `1С: Предприятие`
- Откройте "чистую" базу 1С (хотя подойдет любая база, т.к. обработка *не вносит* никаких изменений)
- В правом верхнем углу нажмите на значок с полосками и стрелкой, в выпадающем меню выберите подменю `Файл`, а нажмите на пункт меню `Открыть...`.
 
![276199615-6e4ffcff-e434-455c-a5d7-84bd4e9fb2c1](https://github.com/anton-petrunov/1C-nevskiy-test/assets/97449490/5a5af57b-a205-4f16-89ca-96448b13d120)
- Откроется проводник и предложит выбрать файл для открытия. Выберите файл с обработкой и нажмите кнопку `Открыть`

![image](https://github.com/anton-petrunov/1C-nevskiy-test/assets/97449490/d1da0794-3a52-40bb-a540-fff94d7b2a3a)
- Появится стандартное предупреждение безопасности. Разрешите открывать это файл, - нажмите `Да`

![image](https://github.com/anton-petrunov/1C-nevskiy-test/assets/97449490/49146605-801e-4a9e-bcdd-e1642b1170bf)
- Откроется форма обработки, и вы можете начать её использование или тестирование.
### Запуск проекта в режиме программиста-разработчика `1С: Конфигуратор`
Поскольку любой, кто читает это краткое руководство, является опытным программистом, то описание этого раздела я опущу :-)
## Что было реализовано
### Пункт 1 ТЗ: заполнение дерева
